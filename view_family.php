...
<br /><br />
<h2>My Family Lists</h2>
<br /><br />


 
								<?php
								$data = mysql_query("SELECT * FROM family WHERE mid='$_SESSION[user]' ") or die(mysql_error());
echo "<b style='color: green'>Total Number of My Familys: ".mysql_num_rows($data);

								 Print "<table border=1 cellpadding=3>"; 
 Print "<tr>";
 print "<th colspan='7'><span  style='color: #44a2ee;' /><u> My Family Filles   </u></span></th>";
print "</tr>";
