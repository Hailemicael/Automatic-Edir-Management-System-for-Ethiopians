...
<h2>Give Permission to Members</h2>
 
								<?php

								 Print "<table border=1 cellpadding=3>"; 
 Print "<tr>";
 print "<th colspan='7'><span  style='color: #44a2ee;' /><u>  Permissions   </u></span></th>";
print "</tr>";
...
Print "<th>&nbsp; </th>";
 ...
 Print "</tr>"; 
 $data = mysql_query("SELECT * FROM permission ") or die(mysql_error());
...
Print "<tr>"; 
 ...
 echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to Allow: ". $info['id']." ?');\" href='allow.php?id=".$info['id']."' class=btn><span  style='color: green;' />Allow</span></a></td>";
  echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to Not Allowed: ". $info['id']." ?');\" href='alloww.php?id=".$info['id']."' class=btn><span  style='color: red;' />Not Allowed</span></a></td>";
	}
  Print "</tr>";
