...
<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Name:</b><input  name="iname"  type="text"   placeholder="Enter Name" pattern="[a-zA-Z ]+" title="please enter only characters" required="required"/><br /><br /> 
...
<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Tel:</b><input  name="tel" pattern="[0-9+]+" title="please enter only characters"  type="tel" /><br /><br /> 
 <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Password:</b><input  name="password" required="required" type="password" value="12345"  />
 <br /><br />
 <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Role:</b><select name="role" required="true">
...
$query=mysql_query("insert into manager values('$iid','$iname','$address','$tel','$password')");
if($query==1)
{
echo "<script>alert(\"Successfully Regestered\") </script>";
echo '<SCRIPT LANGUAGE="JavaScript">
document.location.href="admin_create.php" </SCRIPT>';  
  
}
 
else
{
echo "<script>alert(\"Database Problem b/c of ID is duplication\") </script>";
echo '<SCRIPT LANGUAGE="JavaScript">
document.location.href="admin_create.php" </SCRIPT>';    
}

	}elseif($_POST['role'] == 'accountant'){
		$query=mysql_query("insert into accountant values('$iid','$iname','$address','$tel','$password')");
if($query==1)
{
echo "<script>alert(\"Successfully Regestered\") </script>";
echo '<SCRIPT LANGUAGE="JavaScript">
...
<?php 
 ...
 Print "<tr>";
 print "<th colspan='7'><span  style='color: #44a2ee;' /><u> Manage Account   </u></span></th>";
print "</tr>";
...
Print "<th>&nbsp;</th>"."\n";
 ...
 Print "</tr>"; 
 $data = mysql_query("SELECT * FROM manager ") or die(mysql_error());
...
print "<td> Manager"; 
  echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to Delete: ". $info['id']." ?');\" href='del_account.php?id=".$info['id']."' class=btn><span  style='color: red;' />Delete</span></a></td><tr>";
 
 
  Print "</tr>";
}
  $dataa = mysql_query("SELECT * FROM accountant ") or die(mysql_error());

 while($info = mysql_fetch_array( $dataa )) 
 { 
